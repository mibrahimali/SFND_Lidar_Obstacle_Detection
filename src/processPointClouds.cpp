...
typename pcl::PointCloud<PointT>::Ptr ProcessPointClouds<PointT>::FilterCloud(typename pcl::PointCloud<PointT>::Ptr cloud, float filterRes, Eigen::Vector4f minPoint, Eigen::Vector4f maxPoint)
{
    ...
    typename pcl::PointCloud<PointT>::Ptr vox_cloud (new pcl::PointCloud<PointT>);
    ...
    boxFilter.setInputCloud (vox_cloud);
    boxFilter.filter (*cropped_cloud);

    boxFilter.setMin(Eigen::Vector4f ( -2.0, -1.5, -5.0, 1));
    boxFilter.setMax(Eigen::Vector4f ( 3, 1.5, 5.0, 1));
...
std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::SegmentPlane(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceThreshold)
{
    ...
    // PCL-Library Based Implementation
    ...
    std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> segResult= SeparateCloudsInliersSet<PointT>(inliers, cloud);
    #endif
    auto endTime = std::chrono::steady_clock::now();
    auto elapsedTime = std::chrono::duration_cast<std::chrono::milliseconds>(endTime - startTime);
...
std::vector<typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::Clustering(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize)
{
    ...
    #else
    // Used Defined Implementation
    clusters = euclideanClustering<PointT>(cloud, clusterTolerance, minSize);
    #endif
    auto endTime = std::chrono::steady_clock::now();
    auto elapsedTime = std::chrono::duration_cast<std::chrono::milliseconds>(endTime - startTime);
